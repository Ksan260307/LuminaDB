    ...
    Object.assign(LUMINA_I18N_EN, {
        ...
        'スタイルシート（Tailwind CDN）を読み込めませんでした。表示は簡素になりますが、SQL の実行と保存は問題なく動きます。':
            'The stylesheet (Tailwind CDN) could not be loaded. The look is plainer, but running SQL and saving work exactly as usual.',
